...
@NoArgsConstructor
public class Teacher extends CreatableEntity {
    ...
    @Builder
    public Teacher(Long id, String name, String gender, String address, String phoneNumber, String email, String profilePicture, Status status, User users) {
        this.id = id;
        this.name = name;
        this.gender = gender;
